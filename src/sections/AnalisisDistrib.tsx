      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-5">
            ...
            <CodeBlock
              code={code}
              note="Conteo y porcentaje de operaciones normales vs. fraudulentas sobre el dataset completo."
            />
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div
                ...
                style={{
                  background: "rgba(116,35,132,0.08)",
                  border: "1px solid rgba(116,35,132,0.22)"
                }}
              >
                <div
          ...
          <div className="flex flex-col gap-5">
            ...
            >
              <img
                src="/img/02_operaciones_fraude.png"
                alt="Gráfico Normal vs Fraude"
