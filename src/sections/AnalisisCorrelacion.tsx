    ...
    >
      <div className="max-w-5xl mx-auto w-full">
        ...
        <p className="text-gray-400 mb-8 text-sm max-w-xl">
          Relación entre variables numéricas, con foco en la correlación con la
          variable objetivo{" "}
          <span className="font-mono text-purple-300">fraude</span>.
        </p>

        {/* Top row: code + variables */}
        <div className="grid md:grid-cols-2 gap-6 mb-6">

          <CodeBlock
            code={code}
            note="Correlación de Pearson entre variables numéricas. Se ordenan por relación con fraude."
          />
          ...
          <div>
            ...
            <div className="space-y-2">
              {[
                "0.64 — puntaje_riesgo",
                "0.42 — cambio_dispositivo",
                "0.40 — ubicacion_inusual",
                "0.35 — monto_promedio_usuario",
                "0.27 — llamada_reciente",
              ].map((item, i) => (
                <div
                  key={i}
                  className="flex items-center gap-3 px-3 py-2 rounded-lg"
                  style={{
                    background: "rgba(116,35,132,0.07)",
                    border: "1px solid rgba(116,35,132,0.15)",
                  }}
                >
                  <div
        ...
        <div
          ...
          style={{
            ...
            boxShadow: "0 2px 8px rgba(116,35,132,0.08)",
            background: "#ffffff",
          }}
        >
          ...
          >
            ...
            <span
              ...
              style={{ color: "#7b7086" }}
            >
              Matriz de correlación con variable fraude
            </span>
          </div>

          <img
            src="/img/12_correlacion.png"
